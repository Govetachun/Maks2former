...
_TARGET_DIR = os.path.expanduser('/space/hotel/bachn/implement_model/mxnet/datasets')
...
if __name__ == '__main__':
    ...
    makedirs(os.path.expanduser('/space/hotel/bachn/implement_model/mxnet/datasets'))
